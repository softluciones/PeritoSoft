                                ...
                                if(!Edit3->Text.IsEmpty()){
                                        if(!Edit4->Text.IsEmpty()){
                                                if(!Edit5->Text.IsEmpty()){
                                                        ...
                                                        MessageDlg("Ingrese el año de la fecha del accidente", mtInformation, TMsgDlgButtons() << mbOK, 0);
                                                }
                                        }else{
                                                MessageDlg("ingrese el año del acta de avaluo", mtInformation, TMsgDlgButtons() << mbOK, 0);
                                        }
                                }else{
                                        MessageDlg("Ingrese valor monetario aproximado en daños", mtInformation, TMsgDlgButtons() << mbOK, 0);
                                }
                        }else{
                                MessageDlg("Ingrese lugar del accidente", mtInformation, TMsgDlgButtons() << mbOK, 0);
                        }
                }else{
                        MessageDlg("Ingrese lugar de inspección", mtInformation, TMsgDlgButtons() << mbOK, 0);
                }
        }else{
